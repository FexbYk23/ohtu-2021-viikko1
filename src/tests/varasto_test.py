...
class TestVarasto(unittest.TestCase):
    ...
    def test_ottaminen_liikaa(self):
        ...
        self.assertAlmostEqual(self.varasto.ota_varastosta(100), 1)
    ...
    def test_lisaa_liikaa(self):
        ...
        self.assertAlmostEqual(self.varasto.paljonko_mahtuu(), 0, 0)
    
    def test_init_negatiivinen_saldo(self):
        v = Varasto(1, -1)
        self.assertAlmostEqual(v.paljonko_mahtuu(), 1, 0)
    
    def test_init_tilavuutta_suurempi_saldo(self):
        v = Varasto(1, 2)
